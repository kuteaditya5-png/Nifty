...
<div class="footer">V18.5.1 • Paper trading only • EMA crossover uses completed 5-minute candles • Backtest reports NIFTY underlying points, not option-premium P&amp;L.</div></div>
<script>
...
load();backtest();setInterval(load,30000);
</script></body></html>""")
